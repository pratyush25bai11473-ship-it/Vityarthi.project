...
def draw_restart_button():
    ...
    pygame.draw.rect(screen, (0, 255, 0), button_rect)  # Green button
...
while running:
    ...
    if not game_over:
        ...
        restart_button = draw_restart_button()  # Draw restart button and save rect
